...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchNationalityData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/student-nationality-distribution');
    ...
    const fetchEducationData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/student-highest-education-distribution');
        const updatedData = response.data.map(item => ({
          ...item,
          count: Number(item.count),
        }));
    ...
    const fetchCurrentEducationData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/student-current-education-distribution');
        const updatedData = response.data.map(item => ({
          ...item,
          count: Number(item.count),
        }));
    ...
    const fetchRaceData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/student-race-distribution');
        const updatedData = response.data.map(item => ({
          ...item,
          count: Number(item.count),
        }));
    ...
    const fetchMaritalData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/student-marital-status-distribution');
        const updatedData = response.data.map(item => ({
          ...item,
          count: Number(item.count),
        }));
    ...
    const fetchEmploymentData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/student-employment-status-distribution');
        const updatedData = response.data.map(item => ({
          ...item,
          count: Number(item.count),
        }));
