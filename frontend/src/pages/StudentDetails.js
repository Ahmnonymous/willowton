...
const StudentDetails = () => {
  ...
  const fetchStudentDetails = useCallback(async () => {
    try {
      const response = await fetch("https://localhost/api/student-details");
  ...
  const fetchAboutMe = async (studentId) => {
    try {
      const response = await fetch(`https://localhost/api/about-me/${studentId}`);
      const data = await response.json();
  ...
  const fetchParentsDetails = async (studentId) => {
    try {
      const response = await fetch(`https://localhost/api/parents-details/${studentId}`);
      const data = await response.json();
  ...
  const fetchUniversityDetails = async (studentId) => {
    try {
      const response = await fetch(`https://localhost/api/university-details/${studentId}`);
      const data = await response.json();
  ...
  const fetchAttachmentsDetails = async (studentId) => {
    try {
      const response = await fetch(`https://localhost/api/attachments/${studentId}`);
      const data = await response.json();
      setAttachments(data);
    } catch (error) {
  ...
  const fetchExpenseDetails = async (studentId) => {
    try {
      const response = await fetch(`https://localhost/api/expense-details/${studentId}`);
      const data = await response.json();
  ...
  const fetchAssetsLiabilities = async (studentId) => {
    try {
      const res = await fetch(`https://localhost/api/assets-liabilities/${studentId}`);
  ...
  const fetchAcademicResults = async (studentId) => {
    try {
      const res = await fetch(`https://localhost/api/academic-results/${studentId}`);
      const data = await res.json();
  ...
  const fetchVoluntaryServices = async (studentId) => {
    try {
      const res = await fetch(`https://localhost/api/voluntary-service/${studentId}`);
      const data = await res.json();
  ...
  const fetchPaymentsDetails = async (studentId) => {
    try {
      const response = await fetch(`https://localhost/api/payments/${studentId}`);
      const data = await response.json();
      setPayments(data);
    } catch (error) {
  ...
  const fetchInterviewsDetails = async (studentId) => {
    try {
      const response = await fetch(`https://localhost/api/interviews/${studentId}`);
      const data = await response.json();
      setInterviews(data);
    } catch (error) {
        ...
        try {
          const responses = await Promise.all(
            ["about-me", "parents-details", "university-details", "attachments", "expenses-summary", "assets-liabilities", "academic-results", "voluntary-services", "payments", "interviews"]
              .map((key) => fetch(`https://localhost/api/${key}/${selectedStudent.id}`).then(res => res.json()))
          );
